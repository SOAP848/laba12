...
@router.post("/", response_model=OrderTrackingResponse, status_code=status.HTTP_201_CREATED)
...
def get_estimated_delivery(
    ...
    return {
        ...
        "remaining_minutes": max(0, int((estimated - datetime.utcnow()).total_seconds() / 60))
    }