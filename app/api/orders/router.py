...
from app.dependencies.auth import get_current_user, require_admin, require_restaurant_manager
from app.models.user import User
from app.models.restaurant import Restaurant
from app.models.dish import Dish
from app.models.order import Order, OrderItem, OrderStatus, PaymentStatus
from app.schemas.order import OrderCreate, OrderUpdate, OrderResponse, OrderList, OrderItemCreate
...
def get_order(
    ...
    if current_user.role not in ["admin", "restaurant_manager"] and order.user_id != current_user.id:
        raise HTTPException(
